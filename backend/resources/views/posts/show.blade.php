...
@section('content')
    ...
    <form action="{{ route('comment.store', $post->id) }}" method="post">
        ...
        <div class="input-group mt-5">
            <input type="text" name="comment" value="{{ old('comment') }}" class="form-control" placeholder="Add a comment...">
    ...
    @if($post->comments) <!-- It relates to function comments() of Post.php -->
        <div class="mt-2 mb-5">
            ...
            <div class="row p-2">
                ...
                <div class="col-2 text-end">
                    ...
                    <form action="{{ route('comment.destroy', $comment->id) }}" method="post">
                        @csrf
                        @method('DELETE')
                        <button type="submit" title="Delete comment" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash-can"></i></button>
                    </form>
                    @endif
                </div>
            </div>
